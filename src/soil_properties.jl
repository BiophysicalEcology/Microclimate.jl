...
function soil_properties(soil_thermal::CampbelldeVriesSoilThermal;
    ...
    vapor_pressure = vapour_pressure(vapour_pressure_equation, soil_temperature) * 0.99 #wet_air_properties(soil_temperature, 0.99, atmospheric_pressure; vapour_pressure_equation).vapour_pressure
    vapor_pressure_minus = vapour_pressure(vapour_pressure_equation, soil_temperature - 1u"K") * 0.99 #wet_air_properties(soil_temperature - 1u"K", 0.99, atmospheric_pressure; vapour_pressure_equation).vapour_pressure
    vapor_pressure_plus = vapour_pressure(vapour_pressure_equation, soil_temperature + 1u"K") * 0.99 #wet_air_properties(soil_temperature + 1u"K", 0.99, atmospheric_pressure; vapour_pressure_equation).vapour_pressure
    ################################################################
