...
function runmicro(;
    ...
    profile_buffers = allocate_profile(heights, reference_height)
    ...
    for j in 1:ndays
        ...
        buffers = (; profile=profile_buffers, soil_properties=soil_properties_buffers )
        ...
        @inbounds for iter = 1:niter
            for i in 1:length(hours)
                ...
                if i == 1 # make first hour of day equal last hour of previous iteration
                    ...
                    # {true} specifies in-place mode with four arguments to soile_energy_balance!
    ...
    profile_out = map(1:length(air_temperatures)::Int) do i
