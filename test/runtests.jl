...
@safetestset "evaporation (dew/frost condensation clamp)" begin include("evaporation_test.jl") end
@safetestset "clearness index" begin include("clearness_index_test.jl") end
...
@safetestset "frozen infiltration" begin include("frozen_infiltration_test.jl") end
