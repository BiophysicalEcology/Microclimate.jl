...
@testset "PrescribedStomatalConductance: day/night gating" begin
    ...
    day_conductance = stomatal_conductance(model, day, 0.0u"J/kg", nothing)
    night_conductance = stomatal_conductance(model, night, 0.0u"J/kg", nothing)
...
@testset "MoistureResponsiveStomatalConductance: closes as water potential drops" begin
    ...
    wet = stomatal_conductance(model, day, 0.0u"J/kg", soil_hydraulic_model)
    dry = stomatal_conductance(model, day, -1.0e6u"J/kg", soil_hydraulic_model)
    night_conductance = stomatal_conductance(model, night, 0.0u"J/kg", soil_hydraulic_model)
...
@testset "MoistureResponsiveStomatalConductance: only dispatches with CampbellSoilHydraulics" begin
    model = MoistureResponsiveStomatalConductance()
    @test_throws MethodError stomatal_conductance(model, day, 0.0u"J/kg", nothing)
end
