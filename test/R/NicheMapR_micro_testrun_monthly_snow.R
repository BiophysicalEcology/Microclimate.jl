...
TMINN <- c(-14.3, -12.1, -5.1, 1.2, 6.9, 12.3, 15.2, 13.6, 8.9, 3, -3.2, -10.6) - 5 # minimum air temperatures (°C)
TMAXX <- c(-3.2, 0.1, 6.8, 14.6, 21.3, 26.4, 29, 27.7, 23.3, 16.6, 7.8, -0.4) - 5 # maximum air temperatures (°C)
...
if(write_input){
  if(dir.exists("../data/init_monthly_snow") == FALSE){
    dir.create("../data/init_monthly_snow")
  }
  write.table(as.matrix(microinput), file = "../data/init_monthly_snow/microinput.csv", sep = ",", col.names = NA, qmethod = "double")
  write.table(longlat, file = "../data/init_monthly_snow/longlat.csv", sep = ",", col.names = NA, qmethod = "double")
  write.table(doy, file = "../data/init_monthly_snow/doy.csv", sep = ",", col.names = NA, qmethod = "double")
  write.table(SLES, file = "../data/init_monthly_snow/SLES.csv", sep = ",", col.names = NA, qmethod = "double")
  write.table(DEP, file = "../data/init_monthly_snow/DEP.csv", sep = ",", col.names = NA, qmethod = "double")
  write.table(Nodes, file = "../data/init_monthly_snow/Nodes.csv", sep = ",", col.names = NA, qmethod = "double")
  write.table(MAXSHADES, file = "../data/init_monthly_snow/Maxshades.csv", sep = ",", col.names = NA, qmethod = "double")
  write.table(MINSHADES, file = "../data/init_monthly_snow/Minshades.csv", sep = ",", col.names = NA, qmethod = "double")
  write.table(TIMAXS, file = "../data/init_monthly_snow/TIMAXS.csv", sep = ",", col.names = NA, qmethod = "double")
  write.table(TIMINS, file = "../data/init_monthly_snow/TIMINS.csv", sep = ",", col.names = NA, qmethod = "double")
  write.table(TMAXX, file = "../data/init_monthly_snow/TMAXX.csv", sep = ",", col.names = NA, qmethod = "double")
  write.table(TMINN, file = "../data/init_monthly_snow/TMINN.csv", sep = ",", col.names = NA, qmethod = "double")
  write.table(RHMAXX, file = "../data/init_monthly_snow/RHMAXX.csv", sep = ",", col.names = NA, qmethod = "double")
  write.table(RHMINN, file = "../data/init_monthly_snow/RHMINN.csv", sep = ",", col.names = NA, qmethod = "double")
  write.table(CCMAXX, file = "../data/init_monthly_snow/CCMAXX.csv", sep = ",", col.names = NA, qmethod = "double")
  write.table(CCMINN, file = "../data/init_monthly_snow/CCMINN.csv", sep = ",", col.names = NA, qmethod = "double")
  write.table(WNMAXX, file = "../data/init_monthly_snow/WNMAXX.csv", sep = ",", col.names = NA, qmethod = "double")
  write.table(WNMINN, file = "../data/init_monthly_snow/WNMINN.csv", sep = ",", col.names = NA, qmethod = "double")
  write.table(REFLS, file = "../data/init_monthly_snow/REFLS.csv", sep = ",", col.names = NA, qmethod = "double")
  write.table(PCTWET, file = "../data/init_monthly_snow/PCTWET.csv", sep = ",", col.names = NA, qmethod = "double")
  write.table(soilinit, file = "../data/init_monthly_snow/soilinit.csv", sep = ",", col.names = NA, qmethod = "double")
  write.table(hori, file = "../data/init_monthly_snow/hori.csv", sep = ",", col.names = NA, qmethod = "double")
  write.table(TAI, file = "../data/init_monthly_snow/TAI.csv", sep = ",", col.names = NA, qmethod = "double")
  write.table(soilprops, file="../data/init_monthly_snow/soilprop.csv", sep = ",", col.names = NA, qmethod = "double")
  write.table(moists,file="../data/init_monthly_snow/moists.csv", sep = ",", col.names = NA, qmethod = "double")
  write.table(RAINFALL,file="../data/init_monthly_snow/rain.csv", sep = ",", col.names = NA, qmethod = "double")
  write.table(tannulrun,file="../data/init_monthly_snow/tannulrun.csv", sep = ",", col.names = NA, qmethod = "double")
  write.table(PE,file="../data/init_monthly_snow/PE.csv", sep = ",", col.names = NA, qmethod = "double")
  write.table(BD,file="../data/init_monthly_snow/BD.csv", sep = ",", col.names = NA, qmethod = "double")
  write.table(DD,file="../data/init_monthly_snow/DD.csv", sep = ",", col.names = NA, qmethod = "double")
  write.table(BB,file="../data/init_monthly_snow/BB.csv", sep = ",", col.names = NA, qmethod = "double")
  write.table(KS,file="../data/init_monthly_snow/KS.csv", sep = ",", col.names = NA, qmethod = "double")
  write.table(L,file="../data/init_monthly_snow/L.csv", sep = ",", col.names = NA, qmethod = "double")
  write.table(LAI,file="../data/init_monthly_snow/LAI.csv", sep = ",", col.names = NA, qmethod = "double")
  write.table(tides,file="../data/init_monthly_snow/tides.csv", sep = ",", col.names = NA, qmethod = "double")
  write.table(TAIRhr,file="../data/init_monthly_snow/TAIRhr.csv", sep = ",", col.names = NA, qmethod = "double")
  write.table(RHhr,file="../data/init_monthly_snow/RHhr.csv", sep = ",", col.names = NA, qmethod = "double")
  write.table(WNhr,file="../data/init_monthly_snow/WNhr.csv", sep = ",", col.names = NA, qmethod = "double")
  write.table(CLDhr,file="../data/init_monthly_snow/CLDhr.csv", sep = ",", col.names = NA, qmethod = "double")
  write.table(SOLRhr,file="../data/init_monthly_snow/SOLRhr.csv", sep = ",", col.names = NA, qmethod = "double")
  write.table(RAINhr,file="../data/init_monthly_snow/RAINhr.csv", sep = ",", col.names = NA, qmethod = "double")
  write.table(ZENhr,file="../data/init_monthly_snow/ZENhr.csv", sep = ",", col.names = NA, qmethod = "double")
  write.table(IRDhr,file="../data/init_monthly_snow/IRDhr.csv", sep = ",", col.names = NA, qmethod = "double")
}
