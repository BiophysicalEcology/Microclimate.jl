...
write.csv(TAI, file = 'c:/git/Microclimate.jl/data/TAI_FordDryLake.csv', row.names = FALSE)
write.csv(TAIRhr, file = 'c:/git/Microclimate.jl/data/TAIRhr_FordDryLake.csv', row.names = FALSE)
write.csv(RHhr, file = 'c:/git/Microclimate.jl/data/RHhr_FordDryLake.csv', row.names = FALSE)
write.csv(SOLRhr, file = 'c:/git/Microclimate.jl/data/SOLRhr_FordDryLake.csv', row.names = FALSE)
write.csv(RAINhr, file = 'c:/git/Microclimate.jl/data/RAINhr_FordDryLake.csv', row.names = FALSE)
write.csv(WNhr, file = 'c:/git/Microclimate.jl/data/WNhr_FordDryLake.csv', row.names = FALSE)
write.csv(CLDhr, file = 'c:/git/Microclimate.jl/data/CLDhr_FordDryLake.csv', row.names = FALSE)

write.csv(CampNormTbl9_1, file = 'c:/git/Microclimate.jl/data/CampNormTbl9_1.csv', row.names = FALSE)
